"""
Jessica wants to become a javelin thrower, moreover she wants to become a famous one. However, she doesn’t want to train
...
The good thing about Jack is that he’ll fuse the steel rods together for free. But Jack isn’t that good at fusing things together. When fusing two rods, the fused rod will lose
...
The first line consist of an integer
, the number of steel rods she has. Then follows lines, each containing a single integer representing the length of the steel rod in cm.
.
Output
