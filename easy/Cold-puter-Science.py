...
() that specifies the number of temperatures collected by the University of Chicago Weather Service. The second line contains temperatures, each separated by a single space. Each temperature is represented by an integer (
